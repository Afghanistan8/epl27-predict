...
class AIPredictor(gl.Contract):
    ...
    # the WC '26 market's picks/stakes/claimed pattern).
    ...
    def __init__(self):
        ...
        self.source_url = "https://www.bbc.com/sport/football/premier-league/table"
    ...
    def predict(self, match_id: str, home: str, away: str, date: str) -> typing.Any:
        ...
        def gather_evidence() -> str:
            ...
            return (
                "Upcoming Premier League match to predict:\n"
                f"Home team (plays at home): {home}\n"
                f"Away team: {away}\n"
                f"Match date: {date}\n\n"
                "Current Premier League standings as supplementary evidence "
        ...
        task = (
            ...
            "Premier League match described in the input, at the END OF 90 "
